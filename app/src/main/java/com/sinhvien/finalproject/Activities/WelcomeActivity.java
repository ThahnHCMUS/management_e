...
public class WelcomeActivity extends AppCompatActivity{
    ...
    private ArrayList<PaperOnboardingPage> getDataForOnBoarding() {
        ...
        PaperOnboardingPage src3 = new PaperOnboardingPage("Tiết kiệm chi phí", "Miễn phí cài đặt, triển khai, nâng cấp và hỗ trợ.", Color.parseColor("#ffffff"),
        ...
        PaperOnboardingPage src4 = new PaperOnboardingPage("", "", Color.parseColor("#ffffff"),
                R.drawable.logo3,R.drawable.circle_drawable);
